...
<p align="left"> 
  <img src="https://komarev.com/ghpvc/?username=abdulmuin-said&label=Profile%20Views&color=0e75b6&style=flat" alt="profil-goruntulenme" /> 
</p>

Kastamonu Üniversitesi **Bilgisayar Mühendisliği 2. Sınıf** öğrencisiyim. 

Özellikle **Backend Sistemleri (.NET)**, **Mobil Uygulama Geliştirme (Flutter)** ve **Kurumsal Kaynak Yönetimi (ERP)** konularında kendimi geliştiriyorum. İş süreçlerini dijitalleştiren otomasyon sistemleri geliştirmek üzerine çalışıyorum.
